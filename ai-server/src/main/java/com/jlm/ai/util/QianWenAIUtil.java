...
public class QianWenAIUtil extends AIUtil{
     ...
     */
    public List<QuestionAnalysisDto> reviewExamQuestions(String imagePath) throws IOException, NoApiKeyException, InputRequiredException {
       ...
       /* GenerationResult result = callWithMessage(imagePath, prompt);
        ...
        List<QuestionAnalysisDto> questionAnalysisList = analysisUtil.parseAIResultToQuestionAnalysisList(aiResult);
    ...
    @Override
    public List<HomeworkPublishQuestionDto> reviewHomreWorkQuestions(List<String> imageNames) throws IOException {
        // 构建详细的批阅提示词，要求模型返回结构化信息
        ...
        // 解析AI结果为QuestionAnalysis列表
        ZhipuAIImageAnalysisUtil analysisUtil=zhipuAIConfig.zhipuAIImageAnalysisUtil();
        List<HomeworkPublishQuestionDto> questionAnalysisList = analysisUtil.parseAIResultToHomreWorkQuestionList(aiResult);
        return questionAnalysisList;
    }
